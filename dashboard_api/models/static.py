...
class Dataset(BaseModel):
    ...
    source: Optional[Union[NonGeoJsonSource, GeoJsonSource, List[Union[NonGeoJsonSource, GeoJsonSource]]]]
    background_source: Optional[Union[NonGeoJsonSource, GeoJsonSource, List[Union[NonGeoJsonSource, GeoJsonSource]]]]
